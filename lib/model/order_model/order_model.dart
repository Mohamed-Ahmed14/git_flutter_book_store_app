...
class SingleOrderModel {
  ...
  SingleOrderModel({this.data, this.message, this.error, this.status});

  SingleOrderModel.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new DataSingleOrder.fromJson(json['data']) : null;
    message = json['message'];
    if (json['error'] != null) {
      json['error'].forEach((v) {
        error!.add(v);
...
class DataSingleOrder {
  ...
  DataSingleOrder.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    orderCode = json['order_code'];
    total = json['total'];
    name = json['name'];
